                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="page-header">
                                Manage Sub-Category<small>View Sub-Category</small>
                            </h1>
                        </div>
                    </div>
                    <!-- /. ROW  -->
                                    ...
                                    <table width="985px" align="center" bgcolor="pink">
                                        ...
                                        <tr align="center">
                                            <td colspan="6" bgcolor="#3498db">
                                                <h2>View All Sub-Categories Here</h2><br />
                                            </td>
                                        </tr>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><img src="assets/img/<?php echo $subcat_image; ?>" width="60" height="60"></td>
                                                <td><?php echo $subcat_desc; ?></td>

                                                <td> <a href="edit_subcat.php?edit_subcat=<?php echo $subcat_id; ?>">Edit </a></td>
                                                <td><a href="delete_subcat.php?delete_subcat=<?php echo $subcat_id; ?>">Delete</a></td>
